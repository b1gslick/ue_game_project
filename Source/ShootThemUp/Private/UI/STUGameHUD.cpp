...
void ASTUGameHUD::BeginPlay()
{
    ...
    GameWidgets.Add(ESTUMatchState::Pause, CreateWidget<USTUBaseWidget>(GetWorld(), PausedWidgetClass));
...
void ASTUGameHUD::OnMatchStateChanged(ESTUMatchState State) 
{
    ...
    UE_LOG(LogSTUGameHUD, Display, TEXT("State was changed, current state %s"), *UEnum::GetValueAsString(State));
}
